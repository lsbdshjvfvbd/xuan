...
const zpimgs =[
    {url:'../img/工厂店/成品展示1.jpg',title:'展示柜'},
    {url:'../img/工厂店/成品展示2.jpg',title:'简约柜'},
    {url:'../img/工厂店/成品展示4.jpg',title:'厨房柜'},
    {url:'../img/工厂店/成品展示3.jpg',title:'欧风展示柜'},
    {url:'../img/工厂店/成品展示5.jpg',title:'欧风展示柜'},
]
let arr = ''
// 获取作品介绍
zpimgs.forEach(item =>{
